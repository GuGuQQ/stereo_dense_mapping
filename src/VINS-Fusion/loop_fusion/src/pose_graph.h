...
public:
	...
	void addKeyFrame(KeyFrame* cur_kf, int frame_index, bool flag_detect_loop);
///////////////////////iris_2 KeyFrames////
        void addKFIntoVoc(KeyFrame* keyframe,int frame_index);
        void addKFIntoVocself(KeyFrame* keyframe,int frame_index);
        void kflist(KeyFrame* cur_kf);
	void loadKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop);
	void loadVocabulary(std::string voc_path);
	void setIMUFlag(bool _use_imu);
	KeyFrame* getKeyFrame(int index);
	//KeyFrame* getKeyFrame(int index,int iris_flag);
