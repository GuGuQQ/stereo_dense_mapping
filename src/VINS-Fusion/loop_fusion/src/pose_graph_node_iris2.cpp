...
int main(int argc, char **argv)
{
    ...
    VINS_RESULT_PATH = VINS_RESULT_PATH + "/vio_loop_iris_2.csv";
    ...
    ros::Subscriber sub_vio = n.subscribe("/iris_2/vins_estimator/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/iris_2/vins_estimator/keyframe_pose", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/iris_2/vins_estimator/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/iris_2/vins_estimator/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_margin_point = n.subscribe("/iris_2/vins_estimator/margin_cloud", 2000, margin_point_callback);
