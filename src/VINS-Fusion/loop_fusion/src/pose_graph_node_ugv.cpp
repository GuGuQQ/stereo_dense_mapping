...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    odometry.header.frame_id = "ugv_1_map";
...
void vio_callback2(const nav_msgs::Odometry::ConstPtr &pose_msg2)
{
    ...
    odometry.header.frame_id = "ugv_0_map";
    odometry.pose.pose.position.x = vio_t.x();
    odometry.pose.pose.position.y = vio_t.y();
    odometry.pose.pose.position.z = vio_t.z();
    odometry.pose.pose.orientation.x = vio_q.x();
...
int main(int argc, char **argv)
{
    ...
    VINS_RESULT_PATH = VINS_RESULT_PATH + "/vio_loop_ugv_1.csv";
    ...
    ros::Subscriber sub_vio = n.subscribe("/ugv_1/vins_estimator/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/ugv_1/vins_estimator/keyframe_pose_nav", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/ugv_1/vins_estimator/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/ugv_1/vins_estimator/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_margin_point = n.subscribe("/ugv_1/vins_estimator/margin_cloud", 2000, margin_point_callback);
    ...
    ros::Subscriber sub_vio_iris2 = n.subscribe("/ugv_0/vins_estimator/odometry", 2000, vio_callback2);
    ros::Subscriber sub_image_iris2 = n.subscribe(IMAGE_TOPIC_iris2, 2000, image_callback2);
    ros::Subscriber sub_pose_iris2 = n.subscribe("/ugv_0/vins_estimator/keyframe_pose_nav", 2000, pose_callback2);
    ros::Subscriber sub_extrinsic_iris2 = n.subscribe("/ugv_0/vins_estimator/extrinsic", 2000, extrinsic_callback2);
    ros::Subscriber sub_point_iris2 = n.subscribe("/ugv_0/vins_estimator/keyframe_point", 2000, point_callback2);
    ros::Subscriber sub_margin_point_iris2 = n.subscribe("/ugv_0/vins_estimator/margin_cloud", 2000, margin_point_callback2);
/*
