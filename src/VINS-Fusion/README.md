...
```
    ...
    rosbag play YOUR_DATASET_FOLDER/MH_01_easy.bag
```
roslaunch vins vins_bag.launch 
roslaunch vins database.launch


rosrun loop_fusion loop_fusion_node /home/wjj/catkin_workspace/src/VINS-Fusion/config/euroc/euroc_stereo_imu_config.yaml 

################multi_iris_database#########################################
roslaunch vins multi_iris.launch
roslaunch vins database.launch
roslaunch loop_fusion loop.launch
rosrun loop_fusion loop_fusion_node /home/wjj/catkin_workspace/src/VINS-Fusion/config/euroc/multi_euroc_stereo_imu_config.yaml 
rosbag play MH_01_easy.bag
rosbag play MH_02_easy.bag /cam0/image_raw:=/cam2/image_raw /cam1/image_raw:=/cam3/image_raw /imu0:=/imu2
### 3.3 Stereo cameras
